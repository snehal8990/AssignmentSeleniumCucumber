...
public void fill_up_all_the_fields_and_then_tap_on_register_button() {
 ...
 //
 driver.findElement(By.xpath("//*[@id=\"registration\"]/fieldset/div[1]/div[1]/input")).sendKeys("Snehal2392");
 ...
 driver.findElement(By.id("username")).sendKeys("Sneh38"+x);
...
public void fill_up_the_fields_send_to_subject_message() {
    ...
    driver.findElement(By.xpath("/html")).sendKeys("HELOO HERE !!!!");
...
public void enter_phone_pass_newPaa() {
	...
	driver.findElement(By.xpath("//*[@id=\"profile\"]/fieldset/div[6]/div[1]/input")).sendKeys("12345567890");
